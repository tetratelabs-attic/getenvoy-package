...
apk add --no-cache libstdc++ alpine-sdk linux-headers coreutils libgcc gcc g++ clang clang-dev lld libexecinfo-dev libexecinfo-static py2-pip python3 cmake ninja autoconf libtool
