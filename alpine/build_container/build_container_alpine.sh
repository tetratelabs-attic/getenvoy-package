...
apk add --no-cache libstdc++ alpine-sdk linux-headers coreutils libgcc gcc g++ lld libexecinfo-dev libexecinfo-static py2-pip python3 cmake ninja autoconf libtool
